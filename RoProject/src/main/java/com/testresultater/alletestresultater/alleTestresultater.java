...
public List<testresultat> listOppAlleTestresultater(List<testresultat> parameter) throws SQLException {
    ...
    public List<Testresultati> Sammenligneår(testresultat testres) {
        List<Testresultati> listesammenligneår = new ArrayList<>();
        try {
            String query = "SELECT t.uID, t.år, t.uke, r.klasseType, t.watt_60, t.bevegelighet, t.watt_5000_M, t.tid_5000_m, t.watt_2000_M, t.tid_2000_m, t.prosent_ligg_ro, t.kilo_ligg_ro,\n" +
                    "t.prosent_knebøy, t.kilo_knebøy, t.cm_Sargeant, t.sek_3000_m, t.min_3000_m, t.antall_Kr_Hev, t._3000_løp, t.score, u.fornavn, u.etternavn\n" +
                    "FROM testresultater t\n" +
            ...
            Connection connection = createConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(query);
            preparedStatement.setInt(2,testres.getuID());
            ResultSet rs = preparedStatement.executeQuery();
            ...
            while (rs.next()){
                ...
                if (rs.getInt("år") == 2018) {
                    listesammenligneår2018.add(new testresultat(uID, år, uke, klasseID, watt_60, bevegelighet, watt_5000_m, tid_5000_m, watt_2000_m, tid_2000_m, prosent_ligg_ro, kilo_ligg_ro, prosent_knebøy, kilo_knebøy, Cm_Sargeant, sek_3000_m, min_3000_m, antall_Kr_hev, _3000_løp, score, fornavn, etternavn))
                } else if (rs.getInt("år") == 2019) {
                    listesammenligneår2019.add(new testresultat(uID, år, uke, klasseID, watt_60, bevegelighet, watt_5000_m, tid_5000_m, watt_2000_m, tid_2000_m, prosent_ligg_ro, kilo_ligg_ro, prosent_knebøy, kilo_knebøy, Cm_Sargeant, sek_3000_m, min_3000_m, antall_Kr_hev, _3000_løp, score, fornavn, etternavn))
                }
